# Python Script to Remotely Control DJI Osmo Action 4 / 5
This script will allow you to control an DJI Osmo Action 4 / 5 via bluetooth over the BLE communication protocol.
