...
export const DPad: React.FC<DPadProps> = ({ activeDirection, onDirectionChange }) => {
  ...
  const handleClickDirection = (dir: Direction) => {
    onDirectionChange(dir);
    setTimeout(() => onDirectionChange(Direction.NONE), 120);
  };
  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-3 p-4 bg-gray-950/50 rounded-3xl border border-gray-800">
      ...
      <button
        ...
        onClick={() => handleClickDirection(Direction.UP)}
      ...
      <button
        ...
        onClick={() => handleClickDirection(Direction.LEFT)}
